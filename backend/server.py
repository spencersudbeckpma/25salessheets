...
async def get_team_members(current_user: dict = Depends(get_current_user)):
    ...
    # Super admin and state manager see all team members (for RM filter dropdowns)
    if user_role in ['super_admin', 'state_manager']:
    ...
    # Other roles see only their direct reports
...
async def get_dm_team_leaderboard(period: str, current_user: dict = Depends(get_current_user), user_date: str = None):
    ...
    # For each DM, get their agents and aggregate ONLY Total Premium
    dm_stats = []
