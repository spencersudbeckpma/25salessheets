...
import uuid
from datetime import datetime, timezone, timedelta, date, date
import bcrypt
import jwt
import string
import random
...
async def get_period_report(report_type: str, period: str, current_user: dict = Depends(get_current_user), user_id: str = None, month: str = None):
    """
