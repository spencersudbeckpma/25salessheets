...
import { 
  ...
  DollarSign, CheckCircle, AlertCircle, Users, X
} from 'lucide-react';
...
const SNATracker = ({ user }) => {
  const [snaAgents, setSnaAgents] = useState([]);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Track new agents for 15 weeks • $30,000 premium goal
          </p>
        </div>
        <Button
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <Card className="bg-gradient-to-br from-blue-500 to-blue-600 text-white">
          <CardContent className="p-4">
            <div className="text-3xl font-bold">{snaAgents.length}</div>
            <div className="text-sm opacity-90">Agents Tracked</div>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-green-500 to-green-600 text-white">
          <CardContent className="p-4">
            <div className="text-3xl font-bold">
              {snaAgents.filter(a => a.on_pace).length}
            </div>
        ...
        <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white">
          <CardContent className="p-4">
            <div className="text-3xl font-bold">
              ${(snaAgents.reduce((sum, a) => sum + a.total_premium, 0) / 1000).toFixed(1)}K
            </div>
              ...
              <CardContent className="p-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  <div className="bg-gray-50 rounded p-2">
                    ...
                    <div className="font-semibold">{agent.weeks_in} of 15</div>
                  </div>
                  <div className="bg-gray-50 rounded p-2">
                    <div className="text-gray-500 flex items-center gap-1">
                      <DollarSign size={12} />
          ...
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-gray-500 mt-3">
                This will start tracking their premium progress toward the $30,000 goal over 15 weeks.
              </p>
            </div>
