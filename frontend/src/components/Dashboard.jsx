      ...
      <div className="container mx-auto px-2 md:px-4 py-4 md:py-6 max-w-7xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 md:space-y-6">
          <div className="overflow-x-auto -mx-2 px-2">
            <TabsList className={`inline-flex w-full md:grid md:w-full ${user.role === 'state_manager' ? 'md:grid-cols-8' : 'md:grid-cols-5'} gap-1 md:gap-2 bg-white rounded-lg shadow-md p-1.5 md:p-2 h-auto min-w-max md:min-w-0`} data-testid="dashboard-tabs">
              <TabsTrigger 
                value="activity" 
